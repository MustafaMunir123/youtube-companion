...
import {
  useGetInfiniteConversationById,
...
import { CHAT_HISTORY_LENGTH, ExportChatDuration, ErrorMessages } from '@/utils/constants';
import { getChatHistory } from '@/utils/helpers';
...
export const PreviousChat = ({
  ...
  const handlePromptSubmit = async (data: IChatPrompt) => {
    ...
    const payloadChatHistory: ChatObject = {
      messages: getChatHistory(chatPromptHistoryAtom, ['role', 'content']),
    };
